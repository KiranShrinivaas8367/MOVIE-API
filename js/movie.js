...
function nav_ele_upd(){
    nav_det.innerHTML=`
        ...
        <div class="header-1">
            ...
            <div class="details">
            <div class="run">${mov_details['runtime']}mins</div>
            <div class="release">${mov_details['release_date']}</div>
            </div>
        </div>
        ...
        <div class="header-3">
            <div class="movie-rate">
                ...
                <div class="rating">
                    <span class='${getcolor(mov_details['rating'])}'>${mov_details['rating'].toFixed(1)}</span>/10
                </div>
            </div>
            ...
            <div class="movie-lang">
                ...
                <div class="language">${mov_details['language'].spoken_languages[0].english_name}</div>
            </div>
                    ...
                    <div class="pos_img_det">
                        ...
                        <div class="pos_movie_det">
                            <div class="movie-title">
                                <h2>Original Name: <span class="mov_value">${mov_details['original_title']}</span></h2>
