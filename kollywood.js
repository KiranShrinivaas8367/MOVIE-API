...
const tamil = document.querySelector('.movies-cont-wrap-tam')
const tam_arrow = document.querySelector('.mov-wrap .arrow-btn')
...
async function showTamil(datas){
    ...
    tam_arrow.innerHTML=`<div class="arrow-btn">
